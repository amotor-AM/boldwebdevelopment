...
import Hero from "@/app/assets/images/aboutHero.png"
import Objects from "@/app/assets/images/objects.png"
...
function About() {
  return (
    <div className="wrapper">
      <div className="flex flex-col h-auto lg:flex-row justify-center gap-10 lg:gap-20 items-start pt-12">
        <div className="w-[45%]">
          <h1 className="text-white text-4xl lg:text-6xl md:text-8xl font-bold pb-20">
            We Don't Build Websites. <br />We Build Businesses.
          </h1>
